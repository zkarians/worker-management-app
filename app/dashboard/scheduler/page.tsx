    ...
    return (
        <div className="p-4 sm:p-6 h-[calc(100vh-6rem)] flex flex-col">
            <div className="flex-1 flex gap-4 sm:gap-6 overflow-hidden">
                {/* Left: Calendar Grid */}
                <GlassCard className="flex-1 bg-white border-slate-200 shadow-sm h-full flex flex-col overflow-hidden">
                    {/* Header */}
                                ...
                                {calendarDays.map((day, idx) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={`
                                                p-1 sm:p-1.5 relative group transition-all cursor-pointer rounded-lg border-2 flex flex-col min-h-[80px]
                                            ...
                                            <div className="space-y-0.5 overflow-y-auto h-full scrollbar-hide flex-1">
                                                {daySchedules.map((schedule, i) => (
                                                    <div
                                                        key={schedule.id}
                                                        className={`
                                                            text-[7px] sm:text-[8px] p-0.5 px-1 rounded border font-semibold truncate
                                                            ${schedule.isPopup
                ...
                {/* Right: Side Panel */}
                <GlassCard className="w-80 bg-white border-slate-200 shadow-sm flex flex-col overflow-hidden">
