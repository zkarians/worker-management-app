...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden" suppressHydrationWarning>
            {/* Background Elements */}
            {mounted && (
                <>
            ...
            <GlassCard className="w-full max-w-md animate-fade-in border-slate-200 shadow-2xl shadow-indigo-500/5 bg-white/80">
                ...
                <div className="mt-8 flex flex-col gap-3 text-center text-sm text-slate-500">
                    <Link href="/login/forgot-password" className="text-slate-600 hover:text-indigo-600 transition-colors">
                        비밀번호를 잊으셨나요?
                    </Link>
                    <div>
                        계정이 없으신가요?{' '}
