            ...
            <GlassCard className="w-full max-w-md relative animate-fade-in bg-white border-slate-200">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex items-center gap-2">
                        <input
                            type="checkbox"
                            id="autoAssignCleaning"
                            checked={autoAssignCleaning}
                            onChange={(e) => setAutoAssignCleaning(e.target.checked)}
                            className="w-4 h-4 rounded border-slate-300 bg-white text-blue-600 focus:ring-blue-500"
                        />
                        <label htmlFor="autoAssignCleaning" className="text-sm text-slate-600">
                            청소/파레트 자동 배정 (순서/담당자 기준)
                        </label>
                    </div>
