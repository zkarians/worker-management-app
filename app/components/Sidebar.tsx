...
import { LayoutDashboard, Users, Calendar, Clock, FileText, Settings, LogOut, Truck, ClipboardList, Package, TrendingUp, CalendarCheck, Activity } from 'lucide-react';
...
const MENU_ITEMS = [
    ...
    { name: 'TBM 일지', icon: ClipboardList, href: '/dashboard/tbm', roles: ['MANAGER'] },
    { name: '설정', icon: Settings, href: '/dashboard/settings', roles: ['MANAGER', 'WORKER'] },
    { name: '시스템 모니터', icon: Activity, href: '/dashboard/monitor', roles: ['MANAGER'] },
];
