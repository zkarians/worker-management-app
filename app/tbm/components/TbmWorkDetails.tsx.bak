            ...
            <table border={0} cellPadding={0} cellSpacing={0} width={1106} style={{ borderCollapse: 'collapse', tableLayout: 'fixed', width: '825pt' }}>
                ...
                <tbody>
                    ...
                    <tr style={{ height: '24.95pt' }}>
                        ...
                        <td colSpan={10} className="xl254 tbm-indent-left" style={{ borderRight: '1.0pt solid black' }}>{safetyEducation[0]}</td>
                    </tr>
                    <tr style={{ height: '24.95pt' }}>
                        ...
                        <td colSpan={10} className="xl254 tbm-indent-left" style={{ borderRight: '1.0pt solid black' }}>{safetyEducation[1]}</td>
                    </tr>
                    <tr style={{ height: '24.95pt' }}>
                        ...
                        <td colSpan={10} className="xl237 tbm-indent-left" style={{ borderRight: '1.0pt solid black' }}>{safetyEducation[2]}</td>
                    </tr>
                    <tr style={{ height: '24.95pt' }}>
                        ...
                        <td colSpan={7} className="xl183 tbm-indent-left" width={413} style={{ borderRight: '.5pt solid black', width: '308pt' }}>화물의 중량은 지게차의 정격하중을 초과하지 않을 것</td>
                        ...
                        <td colSpan={8} className="xl206 tbm-indent-left" style={{ borderRight: '1.0pt solid black', borderLeft: 'none' }}>화물 입출하 작업시 차량간 사고 및 작업자 간 부딪힘</td>
                    </tr>
                    <tr style={{ height: '24.95pt' }}>
                        <td colSpan={7} height={33} className="xl183 tbm-indent-left" width={413} style={{ borderRight: '.5pt solid black', height: '24.95pt', width: '308pt' }}>화물이 운전자의 시야를 방해 않도록 후진 이동 할 것</td>
                        <td colSpan={8} className="xl169 tbm-indent-left" style={{ borderRight: '1.0pt solid black' }}>온열기구 사용법 및 화재예방 안전수칙</td>
                    </tr>
                    <tr style={{ height: '24.95pt' }}>
                        <td colSpan={7} height={33} className="xl183 tbm-indent-left" width={413} style={{ borderRight: '.5pt solid black', height: '24.95pt', width: '308pt' }}>인체에 위험한 화물 시 위험성에 대한 교육을 실시 할 것</td>
                        ...
                        <td colSpan={3} className="xl169 tbm-indent-left" style={{ borderRight: '.5pt solid black' }}>안전장구(모, 화, 장갑) 착용</td>
                        <td colSpan={5} className="xl183 tbm-indent-left" width={295} style={{ borderRight: '1.0pt solid black', borderLeft: 'none', width: '220pt' }}>위험요소 여부(위험성평가 숙지 여부)</td>
                    </tr>
                    <tr style={{ height: '24.95pt' }}>
                        <td colSpan={7} height={33} className="xl183 tbm-indent-left" width={413} style={{ borderRight: '.5pt solid black', height: '24.95pt', width: '308pt' }}>붕괴, 전도, 낙하 위험이 있는 화물을 견고하게 묶을 것</td>
                        <td colSpan={3} className="xl169 tbm-indent-left" style={{ borderRight: '.5pt solid black' }}>음주시 근무 부적격</td>
                        <td colSpan={5} className="xl169 tbm-indent-left" style={{ borderRight: '1.0pt solid black', borderLeft: 'none' }}>건강 이상 시 부적합 근무(조퇴 할 것)</td>
                    </tr>
                    <tr style={{ height: '24.95pt' }}>
                        ...
                        <td colSpan={7} className="xl183 tbm-indent-left" width={413} style={{ borderRight: '.5pt solid black', width: '308pt' }}>통행로 확보(폭 1.2m) 및 장애물 있을 시 정리 정돈 할 것</td>
                        ...
                        <td colSpan={8} className="xl169 tbm-indent-left" style={{ borderRight: '1.0pt solid black' }}>작업 개시 전 지게차 안전점검 실시 후 체크리스트 작성</td>
                    </tr>
                    <tr style={{ height: '24.95pt' }}>
                        <td colSpan={7} height={33} className="xl183 tbm-indent-left" width={413} style={{ borderRight: '.5pt solid black', height: '24.95pt', width: '308pt' }}>지면이 평평하지는 못하나<br />수리를 하고 있고 붕괴위험 없음</td>
                        <td colSpan={8} className="xl169 tbm-indent-left" style={{ borderRight: '1.0pt solid black' }}>월1회 정기점검 실시결과 하여 양호할 것</td>
                    </tr>
                    <tr style={{ height: '24.95pt' }}>
                        ...
                        <td colSpan={17} className="xl198 tbm-indent-left" width={1003} style={{ borderRight: '1.0pt solid black', borderLeft: 'none', width: '748pt' }}>
