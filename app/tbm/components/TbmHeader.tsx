        ...
        <table border={0} cellPadding={0} cellSpacing={0} width={1106} style={{ borderCollapse: 'collapse', tableLayout: 'fixed', width: '825pt' }}>
            ...
            <tbody>
                ...
                <tr style={{ height: '24.95pt' }}>
                    ...
                    <td colSpan={8} className="xl203" style={{ borderLeft: 'none' }}>경남 창원시 진해구 신항7로6, 동방웅동물류센터 내</td>
                ...
                <tr style={{ height: '24.95pt' }}>
                    ...
                    <td colSpan={5} className="xl250" style={{ borderLeft: 'none' }}>사내 5km/h, 사외 10km/h이내, 3톤 미만</td>
                    <td colSpan={2} className="xl203 header-shade-center" style={{ borderLeft: 'none' }}>작업장</td>
                    <td colSpan={5} className="xl207" style={{ borderRight: '1.0pt solid black', borderLeft: 'none' }}>강화콘크리트, 평지 / 대지면적: 20,937㎡</td>
                ...
                <tr style={{ height: '24.95pt' }}>
                    ...
                    <td colSpan={5} className="xl209" style={{ borderLeft: 'none' }}>&nbsp;컨테이너 적/출입 작업</td>
                    <td colSpan={2} className="xl229 header-shade-center" style={{ borderLeft: 'none' }}>작업종류</td>
                    <td colSpan={5} className="xl209" style={{ borderRight: '1.0pt solid black', borderLeft: 'none' }}>LG 냉장고, 식기, 컴프레샤, 세탁기</td>
                </tr>
            </tbody>
        </table>
    );
