...
import { Users, Search, Filter, Check, X, Edit2, Trash2, History } from 'lucide-react';
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex items-center gap-2 pt-2 border-t border-slate-200 overflow-x-auto">
                                        {!worker.isApproved && (
                                            <button
                                                onClick={() => handleApprove(worker.id, true)}
                                                className="flex-1 px-3 py-2 rounded-lg bg-green-100 text-green-700 hover:bg-green-200 transition-colors text-sm font-medium flex items-center justify-center gap-2 whitespace-nowrap"
                                            >
                                                <Check size={16} />
                                                승인
                                            </button>
                                        ...
                                        {worker.isApproved && (
                                            <button
                                                onClick={() => handleApprove(worker.id, false)}
                                                className="flex-1 px-3 py-2 rounded-lg bg-yellow-100 text-yellow-700 hover:bg-yellow-200 transition-colors text-sm font-medium flex items-center justify-center gap-2 whitespace-nowrap"
                                            >
                                                <X size={16} />
                                                승인취소
                                            </button>
                                        ...
                                        <button
                                            onClick={() => handleEdit(worker)}
                                            className="flex-1 px-3 py-2 rounded-lg bg-slate-100 text-slate-700 hover:bg-slate-200 transition-colors text-sm font-medium flex items-center justify-center gap-2 whitespace-nowrap"
                                        >
                                            <Edit2 size={16} />
                                            수정
                                        </button>
                                        {worker.resignationDate ? (
                                            <button
                                                onClick={() => handleCancelResign(worker)}
                                                className="flex-1 px-3 py-2 rounded-lg bg-gray-100 text-gray-700 hover:bg-gray-200 transition-colors text-sm font-medium flex items-center justify-center gap-2 whitespace-nowrap"
                                            >
                                                복직
                                            </button>
                                        ) : (
                                            <button
                                                onClick={() => handleResign(worker)}
                                                className="flex-1 px-3 py-2 rounded-lg bg-orange-100 text-orange-700 hover:bg-orange-200 transition-colors text-sm font-medium flex items-center justify-center gap-2 whitespace-nowrap"
                                            >
                                                퇴사
                                            </button>
                                        )}
                                        <button
                                            onClick={() => handleDeleteUser(worker)}
                                            className="flex-1 px-3 py-2 rounded-lg bg-red-100 text-red-700 hover:bg-red-200 transition-colors text-sm font-medium flex items-center justify-center gap-2 whitespace-nowrap"
                                        >
                                            <Trash2 size={16} />
                                            삭제
                                        </button>
